...
const EMAILJS_SERVICE_ID = 'service_8enquye';
const EMAILJS_TEMPLATE_ID = 'template_a8vf44f';
const EMAILJS_PUBLIC_KEY = 'D3mvB3YzdHzLbSq4v';
            ...
            <AnimatePresence mode="wait">
              {status === 'success' ? (
                ...
                >
                  ...
                  <h4 className="font-display font-bold text-slate-100 text-lg">Message Dispatched Securely!</h4>
                  <p className="text-xs text-slate-400 max-w-sm">
                    Thank you. Your message has been sent directly to Aman Kumar's inbox. I will respond to your email soon.
                  </p>
                  <div className="flex gap-1.5 p-3 rounded-lg bg-neutral-900 border border-white-5 font-mono text-[10px] text-zinc-500">
                    <span>EMAIL_DISPATCH</span>
                    <span>//</span>
                    <span className="text-emerald-400">STATUS_200_SENT</span>
                  </div>
                </motion.div>
              ) : null}
              ...
              {status === 'error' ? (
                <motion.div
                  ...
                  id="contact-error"
                >
                  <div className="w-12 h-12 rounded-full bg-red-500/15 border border-red-500/20 flex items-center justify-center text-red-400 text-2xl shadow-lg shadow-red-500/10">
                    <AlertCircle className="w-5 h-5" />
                  </div>
                  <h4 className="font-display font-bold text-slate-100 text-lg">Message Failed to Send</h4>
                  <p className="text-xs text-slate-400 max-w-sm">
                    Something went wrong. Please try again, or email directly at eramanku@gmail.com.
                  </p>
                </motion.div>
              ) : null}
            </AnimatePresence>
